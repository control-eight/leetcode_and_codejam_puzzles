...
public class Solution2 {
    ...
    public static void main(String[] args) {
        System.out.println(new Solution2().evaluate("(add 1 2)"));
        //3
        System.out.println(new Solution2().evaluate("(mult 3 (add 2 3))"));
        //15
        System.out.println(new Solution2().evaluate("(let x 2 (mult x 5))"));
        //10
        System.out.println(new Solution2().evaluate("(let x 2 (mult x (let x 3 y 4 (add x y))))"));
        //14
        System.out.println(new Solution2().evaluate("(let x 3 x 2 x)"));
        //2
        System.out.println(new Solution2().evaluate("(let x 1 y 2 x (add x y) (add x y))"));
        //5
        System.out.println(new Solution2().evaluate("(let x 2 (add (let x 3 (let x 4 x)) x))"));
        //6
        System.out.println(new Solution2().evaluate("(let a1 3 b2 (add a1 1) b2)"));
        //4
        System.out.println(new Solution2().evaluate("(let x 7 -12)"));
        //-12
    }
    ...
    private static class Scope {
        ...
        private Map<Variable, Expr> scope = new HashMap<>();

        public Expr get(Variable key) {
            return scope.get(key);
        }

        public Expr put(Variable key, Expr value) {
            return scope.put(key, value);
        }

        public boolean remove(Variable key, Expr value) {
