...
public class Solution3 {
	...
	public static void main(String[] args) {
		...
		//-1
		System.out.println(new Solution3().coinChange(new int[] {1, 2, 5}, 15));
		//3
		System.out.println(new Solution3().coinChange(new int[] {1}, 0));
		//0
		System.out.println(new Solution3().coinChange(new int[] {3,7,405,436}, 8839));
		//25
		System.out.println(new Solution3().coinChange(new int[] {389,46,222,352,4,250}, 5343));
		//16
		System.out.println(new Solution3().coinChange(new int[] {470,35,120,81,121}, 9825));
		//30
		System.out.println(new Solution3().coinChange(new int[] {438,86,218,138,358,152,129}, 7656));
	}
	...
	private int coinChange(List<Integer> coins, int amount, int coinsAmount) {
		...
		int result1 = coinChange(coins, amount - coins.get(0), coinsAmount + 1);
		int result2 = coinChange(substruct(coins, 0), amount, coinsAmount);
